...
@Component({
  selector: 'app-interaction-reverse-translation-iterator',
  templateUrl: './reverse-translation-iterator.component.html'
})
export class ReverseTranslationIteratorComponent implements OnInit, OnChanges {
