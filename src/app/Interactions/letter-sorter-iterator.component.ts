...
@Component({
  selector: 'app-interaction-letter-sorter-iterator',
  templateUrl: './letter-sorter-iterator.component.html'
})
export class LetterSorterIteratorComponent implements OnInit, OnChanges {
